...
Deno.test("[6, 7, 15, 36, 39, 40, 41, 42, 43, 47, 49]", () => {
  const res = quartile(["6", "7", "15", "36", "39", "40", "41", "42", "43", "47", "49"]);

  assertEquals(res, { Q1: "15", Q2: "40", Q3: "43" });
});

Deno.test("[7, 15, 36, 39, 40, 41]", () => {
  const res = quartile(["7", "15", "36", "39", "40", "41"]);

  assertEquals(res, { Q1: "15", Q2: "37.5", Q3: "40" });
});