...
// theoretically should work faster
Deno.bench("test split + string => int => string conversions", () => {
    "999999999999999999999999999999999999999.999999999999999999999999".split(
        ".",
    );
    "999999999999999999999999999999999999999.999999999999999999999999".split(
        ".",
    ...
    const num1 = (+"999999999999999" + +"9999999999").toString() +
        (+"9999999999" + +"9999999999").toString() +
        (+"9999999999" + +"99999999").toString() +
        (+"9999999999" + +"9999999999").toString() +
        (+"9999999999" + +"99999999").toString() +
        (+"9999999999" + +"9999999999").toString() +
        (+"9999999999" + +"99999999").toString() +
        (+"9999999999" + +"9999999999").toString() +
        (+"9999999999" + +"99999999").toString();
    const num2 = (+"999999999999999" + +"9999999999").toString() +
        (+"9999999999" + +"9999999999").toString() +
        (+"9999999999" + +"99999999").toString();
    const res = num1 + num2;
});
